...
class DriverViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return Constants.DriverViewController.TableView.DefaultNumberOfRows
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = Constants.DriverViewController.TableView.DefaultCellTextLabelText
